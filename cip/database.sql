...
('Standard Room 102', '102', 'Standard Room', 2, 300, 150.00, 'Cozy standard room with city view, queen bed, and modern amenities', TRUE, TRUE, TRUE, 'room2.jpg'),
...
('Deluxe Room 202', '202', 'Deluxe Room', 3, 450, 250.00, 'Elegant deluxe room with premium amenities, king bed, and city skyline view', TRUE, TRUE, TRUE, 'room4.jpg'),
...
('Suite 302', '302', 'Suite', 4, 600, 400.00, 'Executive suite with separate living area, king bed, and panoramic city views', TRUE, TRUE, TRUE, 'room6.jpg'),
('Presidential Suite 401', '401', 'Presidential Suite', 6, 1000, 800.00, 'Ultimate luxury with multiple rooms, private balcony, and premium services', TRUE, TRUE, TRUE, 'room7.jpg');
...
('BK20240115001', 1, 'John Doe', 'john@example.com', '+1-555-0001', '2024-01-15', '2024-01-17', 2, 300.00, 'confirmed'),
('BK20240120002', 2, 'Jane Smith', 'jane@example.com', '+1-555-0002', '2024-01-20', '2024-01-22', 2, 300.00, 'pending'),
('BK20240125003', 3, 'Mike Johnson', 'mike@example.com', '+1-555-0003', '2024-01-25', '2024-01-27', 3, 500.00, 'confirmed'); 